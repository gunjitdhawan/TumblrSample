...
// For sending custom objects between activities
// because 3rd party custom objects cant be sent
// via intent unless they are implemented by parcelable or serializable
// in our case - BLOG class and POST class
